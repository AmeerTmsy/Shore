        ...
        <div className="relative w-full h-screen overflow-hidden">
            ...
            <div className=" border-2 text-gray-300  rounded-full px-4  absolute top-18 right-2 flex gap-2 z-20">
                <div>{audioPlaing ?
                    ...
                    :
                    <span onClick={handlePlay} className="flex items-center gap-2 text-sm">My Work <svg className="inline-block" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M8 5.14v14l11-7z" /></svg></span>
                }</div>
