                ...
                >
                  ...
                  <div className="flex flex-col justify-between flex-1">
                    <div>
                      ...
                      <div className="text-gray-600 text-sm mt-1 ">{rating} ★ <div className={`h-2 w-25 flex bg-gray-300 rounded-full`}> <span className="inline-block h-2 bg-yellow-500 rounded-full" style={{ width: `calc(100px * ( ${rating} / 5))` }}></span></div> <span></span></div>
