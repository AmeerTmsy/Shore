        ...
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {summary.map((s, i) => (
                    <div
                        key={i}
                        className="bg-[#ffffff93] border border-gray-200 shadow rounded-xl p-5 flex flex-col justify-between"
                    >
            ...
            {/* Earnings Trend */}
            <div className="bg-[#ffffff93] border border-gray-200 shadow rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                {/* Payout */}
                <div className="bg-[#ffffff93] border border-gray-200 shadow rounded-xl p-6 flex flex-col justify-between">
                    <div>
                        <div className="flex justify-between items-center mb-4">
            ...
            {/* Transactions */}
            <div className="bg-[#ffffff93] border border-gray-200 shadow rounded-xl overflow-x-auto">
                ...
                <div className="min-w-[700px]">
                    <div className="grid grid-cols-6 px-6 py-3 text-sm text-gray-500 border-b-2 border-gray-200">
                        <p>Date</p>
                        <p>Order ID</p>
                        <p>Gross</p>
                        <p>Fees</p>
                    ...
                    {transactions.map((t, i) => (
                        <div
                            key={i}
                            className="grid grid-cols-6 px-6 py-3 text-sm border-b border-gray-200 hover:bg-gray-50"
                        >
                            <p>{t.date}</p>
