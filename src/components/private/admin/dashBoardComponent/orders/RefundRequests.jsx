          ...
          {stats.map((item, index) => (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span
                  className={`rounded-xl px-3 py-2 text-sm font-bold ${item.badgeColor}`}
                >
                  {item.badge}
                </span>
              </div>
              ...
              <div className="hidden items-center gap-5 xl:flex">
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="h-16 w-full rounded-2xl border border-orange-100 bg-white pl-14 pr-4 text-base outline-none transition focus:border-orange-300"
                  />
                </div>
                ...
                {[
                  ...
                  <button
                    key={index}
                    className="flex h-16 items-center gap-3 rounded-2xl border border-orange-100 px-6 text-lg font-semibold text-gray-700 transition hover:bg-orange-50"
                  >
                    {item}
                    <ChevronDown size={18} />
                  </button>
                ...
                <button className="flex h-16 items-center gap-3 rounded-full bg-gray-100 px-6 text-lg font-semibold text-gray-700">
                  Last 30 Days
                </button>
              </div>
              ...
              <div className="space-y-5 xl:hidden">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-16 w-full rounded-2xl border border-orange-100 bg-white pl-14 pr-4 text-lg outline-none"
                  />
                </div>
                ...
                <div className="flex gap-3 overflow-x-auto pb-2">
                  <button className="flex items-center gap-2 whitespace-nowrap rounded-full border border-orange-200 bg-white px-5 py-4 text-lg font-semibold text-gray-700">
                    <Filter size={18} />
                    Filters
                  </button>

                  <button className="whitespace-nowrap rounded-full bg-indigo-100 px-5 py-4 text-lg font-semibold text-gray-700">
                    Status: Pending ✕
                  </button>

                  <button className="whitespace-nowrap rounded-full border border-orange-200 bg-white px-5 py-4 text-lg font-semibold text-gray-700">
                    High Risk
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="flex items-center gap-2 text-lg font-semibold text-gray-500">
                    Sort by: Date
                    <ChevronDown size={18} />
                  </button>
                </div>
            ...
            <div className="mt-6 hidden overflow-hidden rounded-3xl border border-orange-100 bg-white shadow-sm xl:block">
              <table className="w-full">
                ...
                <tbody>
                  {refunds.map((item, index) => (
                    <tr
                      key={index}
                      className={`border-b border-orange-50 transition hover:bg-orange-50/20
                    ...
                    >
                      ...
                      <td className="px-6 py-8">
                        <span
                          className={`rounded-full px-5 py-2 text-sm font-bold uppercase tracking-wide ${statusBadge(
                            item.status
                          )}`}
                        >
                          {item.status}
              ...
              <div className="flex items-center justify-between border-t border-orange-100 p-6">
                ...
                <div className="flex items-center gap-2">
                  <button className="rounded-2xl border border-orange-100 px-6 py-3 text-lg font-semibold text-gray-400">
                    Previous
                  </button>
                  ...
                  <button className="rounded-2xl border border-orange-100 px-6 py-3 text-lg font-semibold text-gray-700">
                    Next
                  </button>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-2 max-w-[220px] text-4xl font-bold leading-tight text-gray-900">
                        {item.product}
                      </h3>
                    </div>

                    <span
                      className={`rounded-full px-5 py-3 text-lg font-bold ${riskBadge(
                        item.risk
                      )}`}
                    >
                      {item.risk}
                  ...
                  <div className="mt-5 flex items-end justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-2 text-5xl font-bold text-orange-700">
                        {item.amount}
                      </h3>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <span
                        className={`rounded-2xl px-5 py-4 text-lg font-bold ${statusBadge(
                          item.status
                        )}`}
                      >
                        {item.status}
                      ...
                      <button
                        onClick={() => setSelectedRefund(item)}
                        className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gray-100 text-gray-700"
                      >
          ...
          <div className="hidden space-y-6 xl:block">
            ...
            <div className="rounded-3xl border border-orange-200 bg-orange-50 p-6">
              ...
              <div className="mt-5 flex gap-4">
                <h3 className="text-5xl font-bold text-orange-700">
                  12
                </h3>
            ...
            <div className="overflow-hidden rounded-3xl bg-[#1f2937] p-8 text-white shadow-xl">
              ...
              <button className="mt-8 w-full rounded-2xl bg-orange-500 px-6 py-5 text-xl font-bold text-white transition hover:bg-orange-600">
                View Security Log
              </button>
            </div>
          </div>
