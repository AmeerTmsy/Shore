    ...
    return (
        <div className="min-h-screen bg-[#f7f8fa] p-4 md:p-6">
            ...
            <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                <div>
                    <h1 className="text-4xl font-bold tracking-tight text-gray-900">Returns Management</h1>
                    <p className="mt-2 text-base text-gray-500">Monitor and moderate platform-wide return requests</p>
                </div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
                {stats.map((item, index) => (
                    <div
                        key={index}
                        className={`rounded-3xl border bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md ${item.active ? "border-orange-400 ring-1 ring-orange-100" : "border-gray-200"}`}
                    >
                        <div
                        ...
                        <div className="mt-6">
                            ...
                            <h2 className={`mt-2 text-5xl font-bold tracking-tight ${item.active ? "text-orange-600" : "text-gray-900"}`}
                            >{item.value}</h2>
                        </div>
                    </div>
                ))}
                ...
                <div>
                    ...
                    <div className="rounded-3xl border border-orange-100 bg-white p-5 shadow-sm">
                        <div className="flex flex-col gap-4 xl:flex-row">
                            <button className="rounded-2xl border border-orange-200 px-5 py-4 text-left text-sm font-semibold text-gray-700">
                                All Statuses
                            </button>
                            <button className="rounded-2xl border border-orange-200 px-5 py-4 text-left text-sm font-semibold text-gray-700">
                                Refund Status
                            </button>
                            <button className="flex items-center justify-between rounded-2xl border border-orange-200 px-5 py-4 text-left text-sm font-semibold text-gray-700 xl:min-w-[220px]">
                                All Sellers
                                <ChevronDown size={18} />
                            </button>
                            <input
                                type="date"
                                className="rounded-2xl border border-orange-200 px-5 py-4 text-sm font-medium outline-none"
                            />
                        </div>
                    </div>
                    {/* ================================================= */}
                    ...
                    <div className="mt-6 hidden overflow-hidden rounded-3xl border border-orange-100 bg-white shadow-sm xl:block">
                            ...
                            <thead className="bg-[#fcfcfc]">
                                <tr className="border-b border-orange-100">
                                    {[
                                        ...
                                        <th
                                            key={item}
                                            className="px-6 py-6 text-left text-sm font-bold text-gray-600"
                                        >{item}</th>
                                    ))}
                                </tr>
                            </thead>
                                ...
                                {returns.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-7">
                                            <h3 className="text-2xl font-bold text-orange-700">#{item.id}</h3>
                                            <p className="mt-3 text-base text-gray-500">Ord {item.orderId} </p>
                                        </td>
                                        {/* CUSTOMER */}
                                        <td className="px-6 py-7">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h3 className="text-xl font-bold text-gray-900">{item.customer}</h3>
                                                    <div className="mt-2 flex gap-2">
                                                        <span className="rounded-lg bg-indigo-100 px-2 py-1 text-xs font-bold text-indigo-700">SELLER</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-7">
                                            <div className="flex items-center gap-4">
                                                <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-orange-100 bg-gray-50">👟</div>
                                                <div>
                                        ...
                                        {/* REASON */}
                                        <td className="px-6 py-7">
                                            <p className="max-w-[180px] text-lg text-gray-700">{item.reason}</p>
                                        </td>
                                        {/* STATUS */}
                                        <td className="px-6 py-7">
                                            <span
                                                className={`rounded-full px-5 py-2 text-sm font-bold uppercase tracking-wide ${statusBadge(item.status)}`}
                                            >{item.status}</span>
                                        </td>
                                        {/* RISK */}
                                        <td className="px-6 py-7">
                                            <span
                                                className={`rounded-full px-5 py-2 text-sm font-bold uppercase tracking-wide ${riskBadge(item.risk)}`}
                                            >{item.risk}</span>
                                        </td>
                                        {/* ACTIONS */}
                                        <td className="px-6 py-7">
                                            <div className="flex items-center gap-4">
                                                <button
                                                    ...
                                                    className="rounded-xl p-3 text-orange-600 transition hover:bg-orange-100"
                                                >
                                                    <Eye size={22} />
                                                </button>
                        ...
                        <div className="flex items-center justify-between border-t border-orange-100 p-6">
                            <p className="text-lg text-gray-500">Showing 1 to 10 of 2,841 entries</p>
                    ...
                    <div className="rounded-3xl border border-orange-100 bg-white p-6 shadow-sm">
                        <div className="flex items-center gap-3">
                            <AlertTriangle
                                ...
                                size={22}
                            />
                            <h2 className="text-3xl font-bold text-gray-900">Return Insights</h2>
                        </div>
                        <div className="mt-8">
                            <h3 className="text-2xl font-bold text-gray-900">Top Return Reasons</h3>
                            <div className="mt-6 space-y-5">
                                {[
                                    ...
                                    <div key={index}>
                                        <div className="mb-2 flex justify-between text-lg font-semibold text-gray-700">
                                            <span>{item.label}</span>
                                            <span>{item.value}</span>
                                        </div>
                                        <div className="h-3 overflow-hidden rounded-full bg-gray-100">
                                            <div className="h-full w-[45%] rounded-full bg-orange-500" />
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="mt-8 border-t border-gray-100 pt-8">
                            <h3 className="text-2xl font-bold text-gray-900">Quick Actions Required</h3>
                            <div className="mt-6 space-y-4">
                                <div className="rounded-2xl border border-red-100 bg-red-50 p-5">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-xl font-bold text-gray-900">12 High Risk Items</h4>
                                            <p className="text-base text-gray-500">Pending review</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="rounded-2xl border border-orange-100 bg-orange-50 p-5">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-xl font-bold text-gray-900">45 Refunds</h4>
                                            <p className="text-base text-gray-500">To process today</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mt-8 overflow-hidden rounded-3xl bg-[#1f2937] p-8 text-white">
                            <h3 className="text-3xl font-bold leading-tight">Reduce your Return Rate</h3>
                            <p className="mt-4 text-lg text-gray-300">
                                Leverage our AI sizing tool to help customers find
                                their perfect fit before purchase.
                            </p>
                            <button className="mt-8 rounded-2xl bg-orange-500 px-6 py-4 text-lg font-bold text-white transition hover:bg-orange-600">
                                Learn More
                            </button>
                        </div>
                    </div>
                ...
                >
                        ...
                        <div className="flex items-start justify-between gap-4">
                            <div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="rounded-full bg-indigo-100 px-4 py-2 text-sm font-bold uppercase tracking-wide text-indigo-700">
                                        Review State
                                    </span>
                                </div>
                    ...
                    <div className="space-y-8 p-6">
                        ...
                        <div>
                            ...
                            <div className="mt-4 rounded-3xl border border-orange-100 p-5">
                                <div className="flex flex-col gap-5 sm:flex-row">
                                    <div className="flex h-40 w-full items-center justify-center rounded-2xl border border-orange-100 bg-gray-50 sm:w-40">👟</div>
                                    <div className="flex-1">
                                        <h3 className="text-4xl font-bold text-gray-900">Velocity Elite Runner X1</h3>
                                        <p className="mt-3 text-xl text-gray-500">SKU: VEL-X1-882-ORG • Size: 10.5 US</p>
                                        <h4 className="mt-5 text-4xl font-bold text-orange-700">$189.00</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
