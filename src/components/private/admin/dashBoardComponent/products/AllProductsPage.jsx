    ...
    <div className="min-h-screen bg-[#f6f6f7] p-4 lg:p-8">
      <div className="mx-auto max-w-[1700px]">
        ...
        <div className="mt-8 grid grid-cols-2 gap-4 lg:grid-cols-6">
          {stats.map((item, i) => {
            ...
            return (
              <div
                key={i}
                className="rounded-[30px] border border-[#ececec] bg-white p-6"
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#f7f3ee] text-[#b45309]">
                  <Icon size={24} />
                </div>
                ...
                <h3 className="mt-1 text-4xl font-black text-[#171717]">
                  {item.value}
                </h3>
              </div>
            );
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 xl:grid-cols-[1fr_320px]">
          ...
          <div>
            {/* FILTERS */}
            <div className="rounded-[32px] border border-[#ececec] bg-white p-4 lg:p-5">
              <div className="flex flex-col gap-4 lg:flex-row">
                <div className="flex h-16 flex-1 items-center gap-3 rounded-2xl border border-[#f0d8c8] px-5">
                ...
                <div className="flex flex-wrap gap-3">
                  <button className="h-16 rounded-2xl border border-[#f0d8c8] bg-white px-6 font-semibold text-[#4b5563]">
                    All Categories
                  </button>
                  ...
                  <button className="flex h-16 items-center gap-2 rounded-2xl bg-[#f4f4f5] px-6 font-semibold text-[#171717]">
                    <Filter size={18} />
                    Filter
                  </button>
                </div>
      ...
      {/* DRAWER */}
      <div
        className={`fixed right-0 top-0 z-50 h-screen w-full overflow-y-auto bg-[#f8f8f8] transition-transform duration-300 md:w-[760px] ${
