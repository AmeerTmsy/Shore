...
const ManageSellers = () => {
    ...
    const stats = useMemo(
        () => [
            { title: "Total Sellers", value: "18,412", sub: "+12%", icon: <Users className={`h-5 w-5`} size={28} />, color: "text-orange-700", bgColor: 'bg-orange-50' },
            { title: "Active Sellers", value: "15,102", sub: "82%", icon: <TrendingUp className={`h-5 w-5`} size={28} />, progress: 82, color: "text-green-600", bgColor: 'bg-green-50' },
            { title: "Verified Status", value: "92.4%", sub: "KYC Success Up", icon: <BadgeCheck className={`h-5 w-5`} size={28} />, color: "text-blue-600", bgColor: 'bg-blue-50' },
            { title: "Merchant Trust", value: "4.8/5.0", sub: "★★★★★", icon: <Star className={`h-5 w-5`} size={28} />, color: "text-yellow-600", bgColor: 'bg-yellow-50' },
            { title: "Suspended", value: "84", sub: "ATTENTION REQUIRED", icon: <Ban className={`h-5 w-5`} size={28} />, color: "text-red-600", bgColor: 'bg-red-50' },
            { title: "Critical Risk", value: "31", sub: "Fraud Alert", icon: <AlertTriangle className={`h-5 w-5`} size={28} />, color: "text-red-600", bgColor: 'bg-red-50' },
        ],
        []
    );
            ...
            <div className="min-h-screen bg-[#fcfcfd] p-4 md:p-8">
                ...
                <div className="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-6 mb-10">
                    <div>
                        ...
                        <p className="mt-1 text-gray-500 text-sm md:text-md">
                ...
                <div className="md:hidden flex gap-4 overflow-x-auto scrollbar-hide mt-8 pb-2">
                    {stats.map((item, index) => (
                        <div
                            key={index}
                            className="min-w-[190px] rounded-2xl border border-orange-100 bg-white p-4 shadow-sm flex justify-between items-center" 
                        >
                            <div
                                className={`${item.color} w-fit mb-3`}
                            >
                                {item.icon}
                            </div>
                    ...
                    {stats.map((item, index) => (
                        ...
                        >
                            <div className="flex justify-between items-center">
                                <div className={`flex items-start justify-center p-3 rounded-xl ${item.bgColor}`}>
                                    <div
                            ...
                            {item.progress && (
                                <div className={`${item.progress && 'mt-3'} flex items-center gap-2`}>
                                    <div className="h-2 bg-zinc-100 rounded-full overflow-hidden flex-1 ">
                                        <div
                            ...
                            {!item.progress &&
                                ...
                                !item.sub.includes("%") && (
                                    <div
                                        className={`mt-3 text-sm font-bold ${item.title === "Suspended"
                            ...
                            {!item.progress ?
                                item.sub === "ATTENTION REQUIRED"
                                    ? ""
                                    : item.sub.includes("%")
                                        ? <p className="mt-3 text-orange-700 font-bold text-sm text-end">{item.sub}</p>
                                        : ""
                                : ''
                            }
                        </div>
                ...
                {/* FILTER BAR */}
                <div className="mt-10 rounded-xl xl:rounded-full border border-orange-100 bg-white p-2">
                    <div className="flex flex-col xl:flex-row gap-4">
                        <div className="flex-1 h-10 rounded-full border border-orange-100 px-5 flex items-center gap-4">
                            <Search
                            ...
                            <input
                                ...
                                className="w-full bg-transparent outline-none text-sm py-1 text-zinc-700 placeholder:text-zinc-400"
                            />
                        </div>
                        ...
                        <div className="flex flex-wrap gap-4">
                            {["Tier: All", "Status: All", "Region: Global"].map(
                                (item) => (
                                    <button
                                        key={item}
                                        className="h-10 px-6 rounded-full border border-orange-100 bg-white text-zinc-600 text-sm flex items-center gap-2"
                                    >
                                        {item}
                                        <ChevronDown size={18} />
                                    </button>
                            ...
                            <button className="h-10 px-6 rounded-2xl text-orange-700 text-sm font-semibold flex items-center gap-3 rounded-full bg-orange-50">
                                <Star size={16} />
                                Save View
                            </button>
                        </div>
                ...
                <div className="md:hidden mt-10">
                    <div className="flex items-center justify-between mb-5 px-2">
                        ...
                        <button className="text-orange-700 cursor-pointer hover:underline">
                            Filter
                        </button>
                    </div>
                    ...
                    <div className="space-y-6">
                        {sellersData.map((seller) => (
                            ...
                            >
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-3 mt-4">
                                                <span className="px-4 py-0.5 rounded-full bg-green-100 text-green-700 text-xs">
                                                    ELITE PERFORMANCE
                                                </span>

                                                <span className="px-4 py-0.5 rounded-full bg-zinc-100 text-zinc-600 text-xs">
                                                    STABLE RISK
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div className="border-t border-orange-100 mt-4 mb-2" />
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <h4 className=" font-semibold text-zinc-900 mt-3">
                                            $42,500.00
                                        </h4>
                                    </div>
                                ...
                                <div className="border-t border-orange-100 mt-2 mb-4" />
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <button
                                        ...
                                        className="py-2 rounded-xl bg-zinc-100 text-zinc-900 font-semibold"
                                    >
                                        View Profile
                                    </button>

                                    <button className="py-2 rounded-xl bg-zinc-100 text-zinc-900 font-semibold">
                                        Message
                                    </button>

                                    <button className="py-2 rounded-xl bg-red-50 text-red-500 flex items-center justify-center">
                                        <Ban size={20} />
                                    </button>
                                </div>
                            </div>
                    ...
                    {/* MOBILE AI */}
                    <div className="mt-10 rounded-2xl bg-gradient-to-br from-[#071238] to-[#090d16] text-white p-8">
                        <div className="flex items-center gap-3 text-orange-400 font-bold text-xl">
                            <Sparkles size={28} />
                            Velocity AI
                        </div>

                        <p className="mt-8 leading-[1.4] text-zinc-200">
                        ...
                        <button className="mt-10 h-20 rounded-3xl bg-orange-500 text-white text-xl font-bold w-full">
                ...
                <div className="overflow-hidden">
                    <div className="overflow-x-auto">
                        <div className="hidden md:block mt-6 rounded-2xl overflow-hidden border border-orange-100 bg-white min-w-4xl">
                            <div className="grid grid-cols-[1fr_1fr_0.7fr_0.6fr_0.6fr_0.6fr_0.4fr] px-4 py-3 text-zinc-500 font-semibold text-sm border-b border-orange-100">
                                <div className="px-1">SELLER</div>
                                <div className="px-1">STORE</div>
                                <div className="px-1">PERFORMANCE</div>
                                <div className="px-1">VOLUME</div>
                                <div className="px-1">COMPLIANCE</div>
                                <div className="px-1">RISK LEVEL</div>
                                <div className="px-1 text-right">ACTIONS</div>
                            </div>
                            ...
                            {sellersData.map((seller) => (
                                <div
                                    ...
                                    className="grid grid-cols-[1fr_1fr_0.7fr_0.6fr_0.6fr_0.6fr_0.4fr] px-4 py-3 items-center border-b border-orange-100 hover:bg-orange-50 cursor-pointer"
                                >
                                    <div className="flex items-center gap-4 px-1">
                                        ...
                                        <div>
                                            ...
                                            <span className="mt-2 inline-flex px-3 py-0.5 rounded-full bg-orange-100 text-orange-700 text-xs">
                                                {seller.tier}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="px-1">
                                        <div className="flex items-center gap-3">
                                            <div>
                                                {/* <div className="w-10 h-10 rounded-xl border border-orange-200 flex items-center justify-center">
                                                <Store
                                                    size={20}
                                    ...
                                    <div className="px-1">
                                        <div
                                            className={`w-fit px-3 text-xs rounded-full border ${getRiskStyles(
                                                seller.riskColor
                                            )}`}
                                        >
                                            {seller.risk}
                                    ...
                                    <div className="flex items-center justify-end gap-2 px-1">
                                        ...
                                        {/* <button
                                        onClick={() => openDrawer(seller)}
                                        className="h-7 px-3 rounded-full bg-zinc-100 hover:bg-orange-500 hover:text-white text-zinc-800 text-sm transition-all"
                                    >
                                        View Profile
                                    </button> */}
                                    </div>
                ...
                {/* BOTTOM GRID */}
                <div className="hidden md:grid grid-cols-1 xl:grid-cols-3 gap-4 mt-10">
                    {/* LEADERS */}
                    ...
                    <div className="rounded-2xl border border-orange-100 bg-white p-8">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-6">
                            <div className="rounded-xl bg-zinc-50 p-5 border border-gray-200">
                                <p className="text-zinc-500 text-sm">
                                    US-East
                                </p>
                    ...
                    <div className="rounded-2xl border border-orange-100 bg-white p-8">
                        ...
                        <div className="space-y-5 mt-8">
                            {moderationAlerts.map((item, index) => (
                                <div
                                    key={index}
                                    className="rounded-xl bg-red-50 p-6 border-l-2 border-red-500"
                                >
                        ...
                        <div className="mt-6">
                            <h3 className="font-semibold">Complexity health</h3>
                            <div className="flex items-center mt-1 gap-2">
                                <div className="h-3 rounded-full bg-zinc-100 overflow-hidden flex-1">
                                    <div className="w-1/12 h-full bg-green-400" />
                                </div>
                                <p className="text-sm">8.33%</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* AI PANEL */}
                <div className="hidden md:flex mt-10 rounded-2xl bg-gradient-to-br from-[#2f3135] to-[#1f2126] p-10 items-center justify-between gap-10 text-white overflow-hidden">
                    <div className="max-w-4xl">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <span className="inline-flex mt-3 px-4 py-0.5 rounded-full border border-orange-400 text-orange-400  text-xs">
                                    ACTIVE
                                </span>
                            </div>
                        </div>
                    ...
                    <button className="shrink-0 h-20 px-5 rounded-3xl bg-orange-500 hover:bg-orange-600 text-white text-xl font-bold shadow-[0_0_40px_rgba(249,115,22,0.35)] transition-all">
                        View Audit Summary
                    </button>
                </div>
            </div>
