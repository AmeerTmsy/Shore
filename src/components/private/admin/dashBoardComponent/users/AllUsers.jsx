        ...
        <div className="min-h-screen bg-[#f8f8f8] p-3 md:p-8">
            <div className="mx-auto max-w-[1700px] space-y-8">
                ...
                <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <button className="hidden md:flex items-center gap-3 rounded-[28px] bg-orange-500 px-8 py-3 font-semibold text-white shadow-lg shadow-orange-200 transition hover:bg-orange-600">
                        ...
                        return (
                            ...
                            >
                                <div className="">
                                    ...
                                    {item.sub && (
                                        <p
                                            className={`mt-3 text-sm ${item.color.includes("red")
                                                ? "text-red-500"
                                                : "text-gray-500"
                                                }`}
                                        >
                ...
                {/* Filters */}
                <div className="hidden md:flex items-center gap-5 rounded-2xl border border-orange-100 bg-white p-4 py-2">
                    <div className="flex flex-1 items-center gap-3 rounded-xl border border-orange-100 px-5 py-2">
                    ...
                    <div className="flex items-center gap-4 rounded-xl text-sm">
                        <span className=" font-semibold">Filter by Role</span>

                        <select className="rounded-xl border border-gray-300 bg-[#f8f8f8] px-5 py-2 outline-none">
                            <option>All Roles</option>
                        </select>
                    </div>

                    <button className="flex items-center gap-3 rounded-xl border border-orange-100 px-6 py-2 text-sm">
                        <SlidersHorizontal size={16} />
                        More Filters
                    </button>

                    <button className="flex h-9 w-9 items-center justify-center rounded-xl border border-orange-100">
                        <FileText />
                    </button>
                </div>
                ...
                <div className="overflow-x-auto">
                    <div className="min-w-[800px] overflow-hidden rounded-[36px] border border-orange-100 bg-white">
                            <div className="grid grid-cols-[2.2fr_1fr_1.2fr_1fr_1fr] border-b border-orange-100 px-10 py-7 font-semibold uppercase tracking-wide text-gray-500">
                                <div className="px-2">User Info</div>
                                {/* <div>Role</div> */}
                                <div className="px-2">Status</div>
                                <div className="px-2">Activity</div>
                                <div className="px-2">Risk</div>
                                <div className="px-2">Joined</div>
                            </div>

                            {users.map((user, index) => (
                                <div
                                    key={index}
                                    className="grid grid-cols-[2.2fr_1fr_1.2fr_1fr_1fr] items-center border-b border-orange-100 px-5 py-2 transition hover:bg-orange-50/30"
                                    onClick={() => {
                                ...
                                >
                                    <div className="flex items-center gap-5 px-2">
                                        <img
                                            src={user?.avatar}
                                            alt={user?.name}
                                            className="h-10 w-10 aspect-square object-top rounded-full object-cover"
                                        />
                                        <div>
                                            <h3 className="font-semibold">{user?.name}</h3>
                                            <p className="mt-1 text-sm text-gray-500">{user?.email}</p>
                                            <span
                                                className={`rounded-full px-3 text-xs font-medium ${getRoleStyle(
                                                    user?.role
                                                )}`}
                                            >
                                                {user?.role}
                                    ...
                                    {/* <div>
                                        <span
                                            className={`rounded-full px-5 py-2 font-semibold ${getRoleStyle(
                                                user?.role
                                            )}`}
                                        >
                                            {user?.role}
                                    ...
                                    <div className="px-2">
                                        <span
                                            className={`rounded-full px-5 py-2 font-semibold ${getRiskStyle(
                                                user?.risk
                                            )}`}
                                        >
                                            {user?.risk}
                            ...
                            <div className="flex items-center justify-between px-5 py-2">
                                ...
                                <div className="flex items-center gap-4">
                                    <button className="flex h-10 w-10 items-center justify-center rounded-2xl border border-orange-100">
                                        <ChevronLeft />
                                    </button>
                ...
                <div className="hidden grid-cols-3 gap-6 md:grid">
                    <div className="rounded-[34px] border border-orange-100 bg-white p-8">
                        <h2 className="text-xl font-bold">User Health</h2>
                    ...
                    <div className="rounded-[34px] border border-orange-100 bg-white p-8">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-bold">Moderation Alerts</h2>

                            <span className="rounded-lg bg-red-600 px-3 py-1 text-xs text-white">
                                3 NEW
                            </span>
                        </div>
