    ...
    <footer className="bg-[#1c2430] text-gray-300 px-6 md:px-16 py-12">
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="text-sm space-y-2">
          ...
          <p onClick={()=> navigate('/about')} className={`font-light cursor-pointer ${ location.pathname === "/about" ? "text-white" : ""}`}>About Us</p>
          <p onClick={()=> navigate('/careers')} className={`font-light cursor-pointer ${ location.pathname === "/careers" ? "text-white" : ""}`}>Careers</p>
          <p onClick={()=> navigate('/blog')} className={`font-light cursor-pointer ${ location.pathname === "/blog" ? "text-white" : ""}`}>Blog</p>
        </div>
        <div className="text-sm space-y-2 flex flex-col">
          <p className="font-semibold text-white mb-2">SUPPORT</p>
          <Link to={'/faqs'} className={`font-light cursor-pointer ${ location.pathname === "/faqs" ? "text-white" : ""}`}>FAQs</Link>
          <Link to={'/shipping-returns'} className={`font-light cursor-pointer ${ location.pathname === "/shipping-returns" ? "text-white" : ""}`}>Shipping & Returns</Link>
          <Link to={'/contact'} className={`font-light cursor-pointer ${ location.pathname === "/contact" ? "text-white" : ""}`}>Contact</Link>
        </div>
      </div>
